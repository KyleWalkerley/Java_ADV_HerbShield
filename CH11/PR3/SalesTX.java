...
public class SalesTX {
    ...
    public static class Builder{
        ...
        public SalesTX.Builder txnId(long val){
            this.txnId = val;
            return this;
        }


        public SalesTX.Builder salesPerson( String val){
            this.salesPerson = val;
            return this;
        }

        public SalesTX.Builder buyer(Buyer val){
            this.buyer = val;
            return this;
        }

        public SalesTX.Builder product(String val){
            this.product = val;
            return this;
        }


        public SalesTX.Builder paymentType( String val){
            this.paymentType = val;
            return this;
        }

        public SalesTX.Builder unitPrice(double val){
            this.unitPrice = val;
            return this;
        }

        public SalesTX.Builder unitCount(double val){
            this.unitCount = val;
            return this;
        }

        public SalesTX.Builder txnDate(LocalDate val){
            this.txnDate = val;
            return this;
        }

        public SalesTX.Builder city(String val){
            city = val;
            return this;
        }

        public SalesTX.Builder state(State val){
            state = val;
            return this;
        }

        public SalesTX.Builder code(String val){
            code = val;
            return this;
        }

        public SalesTX build(){
            return new SalesTX(this);
        }
    }
    ...
    private SalesTX(SalesTX.Builder builder){
        txnId = builder.txnId;
    ...
    public static int sortByBuyer(SalesTX a, SalesTX b){
    ...
    public static List<SalesTX> createTxnList(){
        List<SalesTX> txnList = new ArrayList<>();
